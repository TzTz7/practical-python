...
def portfolio_report(portfoliofile, pricefile, fmt = 'txt'):        
    ...
    '''
    # Read data files 
    portfolio = read_portfolio(portfoliofile) #stock list
    prices = read_prices(pricefile) # dict {name:price, ...}
...
def main(args):
    ...
    '''
    print(read_portfolio(args[1]))
        python .\report.py .\Data\portfolio.csv .\Data\prices.csv html
